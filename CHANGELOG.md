...
- Added plan mode and goal mode.
- Added foreground app/window sampling.
- Added optional screen snapshots and local OCR.
- Added OpenAI-compatible AI summary generation.
